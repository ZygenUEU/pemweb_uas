...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pasien_rumah_sakit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pasien_rumah_sakits.update", [$pasien_rumah_sakit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="namapasien">{{ trans('cruds.pasien_rumah_sakit.fields.namapasien') }}</label>
                <input class="form-control {{ $errors->has('namapasien') ? 'is-invalid' : '' }}" type="text" name="namapasien" id="namapasien" value="{{ old('namapasien', $pasien_rumah_sakit->namapasien) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penyakit') ? 'is-invalid' : '' }}" type="text" name="penyakit" id="penyakit" value="{{ old('penyakit', $pasien_rumah_sakit->penyakit) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umur') ? 'is-invalid' : '' }}" type="text" name="umur" id="umur" value="{{ old('umur', $pasien_rumah_sakit->umur) }}" required>
                @if($errors->has('umur'))
                    <div class="invalid-feedback">
                        {{ $errors->first('umur') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kelamin') ? 'is-invalid' : '' }}" type="text" name="kelamin" id="kelamin" value="{{ old('kelamin', $pasien_rumah_sakit->kelamin) }}" required>
