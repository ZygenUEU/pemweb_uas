...
@section('content')
@can('pasien_rumah_sakit_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.pasien_rumah_sakits.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.pasien_rumah_sakit.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.pasien_rumah_sakit.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('pasien_rumah_sakit_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.pasien_rumah_sakits.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.pasien_rumah_sakits.index') }}",
    columns: [
